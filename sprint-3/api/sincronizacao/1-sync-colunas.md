# Tarefa — Colunas de sincronização (migração V21) · API
...
## Passo a passo
1. Migração `V21`: adicionar `uuid`, `versao`, `atualizado_em`, `deletado` (soft-delete) às tabelas de domínio.
...
- [ ] Flyway aplica V21; entidades expõem os novos campos
