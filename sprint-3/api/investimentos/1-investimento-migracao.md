...
## O que fazer
Criar a migração Flyway **V18** que cria a tabela `investimento` e espelhar os scripts no repo `contas-domesticas-db`.
...
- [ ] App sobe em `dev` e o Flyway aplica V18 sem erro
