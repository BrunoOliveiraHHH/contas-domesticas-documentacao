...
## O que fazer
Criar a migração Flyway **V16** que cria a tabela `lista_compra` e espelhar os scripts no repo `contas-domesticas-db`.

## Passo a passo
1. Criar `src/main/resources/db/migration/V16__cria_tabela_lista_compra.sql`.
...
## Onde mexer
- `contas-domesticas-api/src/main/resources/db/migration/V16__cria_tabela_lista_compra.sql`
