...
2. Mapear os campos: lista_compra_id (FK), produto_id (FK catálogo), quantidade numeric(12,3), unidade_medida_id, mercado_escolhido_id, preco_unitario (snapshot da cotação escolhida), comprado boolean.
